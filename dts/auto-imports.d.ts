...
declare global {
  ...
  const TaskList: typeof import('../app/(protected)/tasks/components/TaskList')['TaskList']
  ...
  const copyText: typeof import('../core/helpers')['copyText']
  ...
  const taskIdSchema: typeof import('../schemas/tasks')['taskIdSchema']
